...
int main()
{
	...
	int dir_number, out_velocity_x, out_velocity_y, out_elevation, out_depht, out_outlet_on, dir_it, N, cols, rows, i, lpout, lkout, nst,n_out,outx,outy;
	...
	int *h_infx, *h_infy;//, *h_infsw, *h_inf;
